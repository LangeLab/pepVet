...
#'
#' A curated reference table for the 20 standard amino acids used by pepVet
#' scoring and validation utilities. The `molecular_weight` column stores free
#' amino acid monoisotopic masses rather than peptide residue masses, so
#' residue-level masses are obtained by subtracting the mass of water
#' (18.01056 Da). The `pKa_side_chain` column stores conventional reference
