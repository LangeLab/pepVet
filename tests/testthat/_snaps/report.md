# BSA trypsin report matches snapshot (Good/Moderate verdict)
    ...
    Output
      ...
      sp|P02769|ALBU_BOVIN Albumin OS=Bos taurus OX=9913 GN=ALB PE=1 SV=4  v Good  (composite: 0.885)
        S_length   ███████░░░ 0.688
        S_coverage ██████████ 0.997
        S_count    ██████████ 1.000
        S_hydro    ████████░░ 0.769
...
# Histone H3 trypsin report matches snapshot (Poor verdict)
    ...
    Output
      ...
      sp|P68431|H31_HUMAN Histone H3.1 OS=Homo sapiens OX=9606 GN=H3C1 PE=1 SV=2  ! Moderate  (composite: 0.619)
        S_length   ███░░░░░░░ 0.305
        S_coverage ██████░░░░ 0.632
        S_count    ███████░░░ 0.662
        S_hydro    ████████░░ 0.833
...
# multi-enzyme comparison report matches snapshot
    ...
    Output
      ...
      -----------------------------------------------------------------------------------------
      > trypsin                           0.688  0.997  1.000  0.769  0.778  0.885  Good    
        glutamyl endopeptidase            0.681  0.936  1.000  0.802  0.975  0.884  Good    
        lysc                              0.628  0.857  1.000  0.763  0.776  0.823  Good    
        asp-n endopeptidase               0.494  0.529  0.923  0.725  0.925  0.673  Good    
      --------------------------------------------------------------------------------
...
# Histone H3 multi-enzyme comparison report matches snapshot
    ...
    Output
      -- sp|P68431|H31_HUMAN Histone H3.1 OS=Homo sapiens OX=9606 GN=H3C1 PE=1 SV=2 --
        enzyme                            S_len  S_cov  S_cnt  S_hyd  S_chg  composite  verdict
      -----------------------------------------------------------------------------------------
      > lysc                              0.593  0.735  1.000  0.625  0.938  0.769  Good    
        trypsin                           0.305  0.632  0.662  0.833  0.833  0.619  Moderate
        asp-n endopeptidase               0.333  0.404  0.640  1.000  1.000  0.578  Moderate
      --------------------------------------------------------------------------------
