...
# Histone H3 trypsin report matches snapshot (Poor verdict)
    ...
    Output
      ...
      sp|P68431|H31_HUMAN Histone H3.1 OS=Homo sapiens OX=9606 GN=H3C1 PE=1 SV=2  x Poor  (composite: 0.350)
        S_length   █░░░░░░░░░ 0.133
        S_coverage ██░░░░░░░░ 0.235
        S_count    ████░░░░░░ 0.353
        S_hydro    ██████████ 1.000
...
# BSA lysc report matches snapshot
    ...
    Output
      ...
      sp|P02769|ALBU_BOVIN Albumin OS=Bos taurus OX=9913 GN=ALB PE=1 SV=4  ! Moderate  (composite: 0.690)
        S_length   ██████░░░░ 0.623
        S_coverage ████████░░ 0.761
        S_count    ████████░░ 0.751
        S_hydro    ███████░░░ 0.737
...
# multi-enzyme comparison report matches snapshot
    ...
    Output
      ...
      -----------------------------------------------------------------------------------------
      > glutamyl endopeptidase            0.633  0.827  0.751  0.763  0.947  0.772  Good    
        lysc                              0.623  0.761  0.751  0.737  0.553  0.690  Moderate
        trypsin                           0.532  0.786  0.830  0.762  0.429  0.674  Moderate
        asp-n endopeptidase               0.488  0.445  0.395  0.750  0.950  0.567  Moderate
      --------------------------------------------------------------------------------
...
# Histone H3 multi-enzyme comparison report matches snapshot
    ...
    Output
      -- sp|P68431|H31_HUMAN Histone H3.1 OS=Homo sapiens OX=9606 GN=H3C1 PE=1 SV=2 --
        enzyme                            S_len  S_cov  S_cnt  S_hyd  S_chg  composite  verdict
      -----------------------------------------------------------------------------------------
      > asp-n endopeptidase               0.600  0.404  0.265  1.000  1.000  0.604  Moderate
        lysc                              0.429  0.522  0.529  0.833  0.833  0.594  Moderate
        trypsin                           0.133  0.235  0.353  1.000  0.250  0.350  Poor    
      --------------------------------------------------------------------------------
