...
Default weights came from pairwise Analytic Hierarchy Process judgments on a 1 to 9 Saaty scale. They encode the relative importance chosen for pepVet and were not fitted to experimental outcomes. Coverage and peptide count receive the largest combined weight. The pairwise matrix has a consistency ratio of 0.03 under the AHP calculation. That value describes internal consistency of the judgments, not empirical validity of the weights.
